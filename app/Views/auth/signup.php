    ...
    <main class="m-0 p-0">
        ...
        <section class="m-0 p-0 row justify-content-center">
            <div class="col-md-4 col-10">
                <div class="card mt-5">
                    <div class="card-body">
                        <h6 class="text-center fw-bold display-6">Sign Up</h6>
                        <form action="" class="form" method="POST">
                            ...
                            <table class="w-100" style="border-collapse: separate;border-spacing:0rem 1.5rem;">
                                ...
                                <tr>
                                    <td><label>Github's username</label></td>
                                    <td> <input type="text" name="githubUsername" class="form-control w-100" /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td> <input type="password" name="confirmPassword" class="form-control w-100" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan=2>
                        ...
                        <p style="font-size:0.8rem;">Already have an account ?
                            <a href=<?= site_url("auth") ?>>click here</a>
                        </p>
                    </div>
                </div>
            </div>
